...
#define AI_NETWORK_MODEL_SIGNATURE     "6bb1ea07e12bacd313f49e7e9eaa7fce"
...
#define AI_TOOLS_DATE_TIME   "Sun Jun 25 18:47:13 2023"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 17552, 1, 1),
    17552, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 252);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 252);
    
    dense_14_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 256);
    dense_14_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 256);
    
    dense_14_output_array.data = AI_PTR(g_network_activations_map[0] + 256);
    dense_14_output_array.data_start = AI_PTR(g_network_activations_map[0] + 256);
    ...
    dense_16_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 256);
    dense_16_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 256);
    ...
    dense_17_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    dense_17_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
    
    dense_17_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    dense_17_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_14_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 0);
    dense_14_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    
    dense_15_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_15_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 128);
    dense_15_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 128);
    
    dense_15_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_15_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 8320);
    dense_15_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 8320);
    
    dense_16_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_16_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 8576);
    dense_16_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 8576);
    
    dense_16_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_16_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 16768);
    dense_16_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 16768);
    
    dense_17_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_17_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 16896);
    dense_17_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 16896);
    
    dense_17_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_17_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 17408);
    dense_17_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 17408);
    
    dense_14_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_14_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 17424);
    dense_14_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 17424);
